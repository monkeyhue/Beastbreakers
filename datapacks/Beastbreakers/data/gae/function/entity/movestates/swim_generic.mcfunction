...
#// Might as well jump!
execute unless score @s monkeylib.entity.fallSpeed < #0 monkeylib.temp1 if block ^ ^0.2 ^0.5 #monkeylib:solid run scoreboard players set @s monkeylib.entity.fallSpeed -52
