...
execute unless block ~ ~-3 ~ #monkeylib:intangible run scoreboard players set #temp monkeylib.temp1 100
execute unless block ~ ~-2 ~ #monkeylib:intangible run scoreboard players set #temp monkeylib.temp1 25
execute unless block ~ ~-1 ~ #monkeylib:intangible run scoreboard players set #temp monkeylib.temp1 10
