...
$execute if score @s monkeylib.entity.fallDistance >= #1 monkeylib.temp1 unless block ~ ~ ~ #monkeylib:fluids as $(coreHitbox) run function monkeylib:damage/simple with storage monkeylib:temp dynamicDmg
