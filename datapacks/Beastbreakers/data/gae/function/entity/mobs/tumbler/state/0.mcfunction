$execute unless score @s monkeylib.entity.AIInit matches 0 run function gae:entity/mobs/tumbler/state/init/$(aiState) with storage gae:root currentEntities.$(id)
